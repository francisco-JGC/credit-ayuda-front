...
export const PreviewClientInfo = ({ client, isLoading }: IProps) => {
  return (
    <div className="flex flex-col gap-4 bg-gray-50 p-4 rounded-lg">
      ...
      {
        isLoading ? (
          <div className="flex items-center justify-center flex-col gap-2 min-h-[300px] ">
            <Spinner />
          ...
          (
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="flex flex-col gap-3">
                ...
                <Input value={client.name} name="name" disabled className="bg-gray-300" />
              </div>

              <div className="flex flex-col gap-3">
                <label htmlFor="" className=" text-gray-500">Cedula de identidad</label>
                <Input value={client.dni} name="dni" disabled className="bg-gray-300" />
              </div>

              <div className="flex flex-col gap-3">
                <label htmlFor="" className=" text-gray-500">Teléfono Principal</label>
                <Input value={client.primary_phone} name="primary_phone" disabled className="bg-gray-300" />
              </div>

              <div className="flex flex-col gap-3">
                <label htmlFor="" className=" text-gray-500">Dirección Principal</label>
                <Input value={client.primary_address} name="primary_phone" disabled className="bg-gray-300" />
              </div>

              <div className="flex flex-col gap-3">
                <label htmlFor="" className=" text-gray-500">Ruta</label>
                <Input value={client.route_name} name="primary_phone" disabled className="bg-gray-300" />
              </div>
            </div>
          )
      }
